...
-- USER Keymaps
vim.keymap.set({ 'n', 'v' }, '<S-l>', '$', { desc = 'move to end of line' })
vim.keymap.set({ 'n', 'v' }, '<S-h>', '^', { desc = 'move to beginning of line' })

vim.keymap.set('n', 'o', 'o<Esc>', { desc = 'adds a line below and stays in normal mode' })
